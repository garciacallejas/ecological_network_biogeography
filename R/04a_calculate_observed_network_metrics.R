...
# unipartite.conn.null.path <- "data/connectance_null_unipartite_adjacency_matrices/"

bipartite.path <- "data/bipartite_adjacency_matrices/"
# bipartite.null.path <- "data/null_bipartite_adjacency_matrices/"
# bipartite.conn.null.path <- "data/connectance_null_bipartite_adjacency_matrices/"
