...
for mat_i in range(0, len(list_bipartite_matrices_files)):
    ...
    try:
        ...
        for sample_i in range(number_random_samples):
            ...
            np.savetxt('../null_adjacency_matrices/soft_degdist_null_bipartite_adjacency_matrices/' + network_name + "_sample_" + repr(sample_i) + '.csv', sample_with_names, fmt='%s', delimiter=',')
